...
This is a simple project about projects assigned to students.
Two GUI's are provided in the same application: the first one sports a bad design, in which each entity has a CRUD, and you need to take down data in order to edit other entities.
